...
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-job.static.compile.info
call :cmdX xyo-cc --mode=%ACTION% @util/quantum-script-extension-job.dynamic.compile.info
