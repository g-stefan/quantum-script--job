...
#define QUANTUM_SCRIPT_EXTENSION_JOB_VERSION_ABCD                 $VERSION_ABCD
#define QUANTUM_SCRIPT_EXTENSION_JOB_VERSION_STR                 "$VERSION_VERSION"
#define QUANTUM_SCRIPT_EXTENSION_JOB_VERSION_STR_BUILD           "$VERSION_BUILD"
#define QUANTUM_SCRIPT_EXTENSION_JOB_VERSION_STR_DATETIME        "$VERSION_DATETIME"
