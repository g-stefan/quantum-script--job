...
echo -^> local-release quantum-script-extension-job
...
call :cmdX xyo-cc quantum-script-extension-job --archive-release-sha512 --version-file=source/quantum-script-extension-job.version.ini
